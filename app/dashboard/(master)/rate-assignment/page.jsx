...
const RateAssignmentPage = () => {
  ...
  return (
    <div className="p-4 md:p-6 w-full max-w-[1600px] mx-auto space-y-6 bg-white min-h-screen font-sans">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        {/* Rate Details Form */}
        <div className="w-full border border-gray-200 shadow-sm p-6 space-y-6 bg-white">
          ...
          <div className="border border-gray-200 p-4 relative">
             <span className="absolute -top-3 left-3 bg-white px-2 text-[11px] font-bold text-gray-400 uppercase tracking-tighter">Update</span>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex max-w-md">
                <Input placeholder="Search Doctor" className="rounded-none border-gray-300 h-9 text-xs" />
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-w-2xl">
                <div className="flex">
                  <Input placeholder="Select Pr" className="rounded-none border-gray-300 h-9 text-xs" />
                  <Button variant="outline" className="rounded-none border-l-0 border-gray-300 bg-gray-50 px-3 h-9">
                    <Search className="h-4 w-4 text-gray-500" />
                  </Button>
                </div>
                <Input placeholder="Description" className="rounded-none border-gray-300 h-9 text-xs bg-gray-50" readOnly />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
              <div className="space-y-2">
                ...
                <div className="flex">
                  <Input placeholder="Actual Ra" className="rounded-none border-gray-300 h-9 text-xs" />
                  <Button variant="outline" className="rounded-none border-l-0 border-gray-300 bg-gray-50 px-3 h-9">
                    <Search className="h-4 w-4 text-gray-500" />
                  </Button>
                </div>
              ...
              <div className="space-y-2">
                <Label className="text-xs font-bold text-gray-700">Sale Price (QAR)</Label>
                <Input value="0" className="rounded-none border-gray-300 h-9 text-xs bg-gray-100 font-bold" readOnly />
              </div>
            </div>
          </div>

          <div className="flex gap-2 items-center pt-4">
            <Button className="rounded-none bg-black hover:bg-gray-800 text-white font-medium h-10 uppercase text-xs px-8">
        ...
        <div className="w-full border border-gray-200 shadow-sm bg-white overflow-hidden">
          <div className="bg-gray-100 px-4 py-3 border-b border-gray-200 flex justify-between items-center">
            <span className="text-sm font-mono text-gray-600 tracking-wider">Assigned Product List</span>
            <span className="text-xs  text-gray-500 font-mono">Fetched Record(s) : {productList.length}</span>
          </div>

          <div className="p-4 border-b border-gray-100 bg-white flex items-center justify-end gap-3">
            <Label className="text-xs font-bold text-gray-600">Product Description</Label>
            <div className="flex w-72">
              <Input className="rounded-none border-gray-300 h-8 text-xs" placeholder="Filter products..." />
              <Button className="rounded-none bg-black hover:bg-gray-800 text-white text-[10px] px-4 uppercase h-8">
                Search
              </Button>
            </div>
          </div>
              ...
              {productList.length === 0 ? (
                <TableRow className="hover:bg-transparent">
                  <TableCell colSpan={6} className="h-24 text-center p-0">
                    <div className="mx-4 my-4 bg-gray-100 border border-blue-100  text-xs font-bold py-2 uppercase tracking-tight">
                      No records found!
                    </div>
                  </TableCell>
                </TableRow>
                ...
                productList.map((item, index) => (
                  <TableRow key={index} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <TableCell className="border-r border-gray-100 text-xs text-center">{index + 1}</TableCell>
